<template>
  ...
  <div class="main-content">
    <breadcumb :page="'Summary Dashboard'" :folder="'Dashboard'" />
    <b-row>
      <!-- ICON BG -->
      ...
      <b-col lg="3" md="6" sm="12">
        ...
        >
          ...
          <div class="content">
            <p class="text-muted mt-2 mb-0">Activas</p>
      ...
      <b-col lg="3" md="6" sm="12">
        ...
        >
          ...
          <div class="content">
            ...
            <p class="text-primary text-24 line-height-1 mb-2">₡1.00.021</p>
          </div>
        </b-card>
      </b-col>
      <b-col lg="3" md="6" sm="12">
        ...
        >
          ...
          <div class="content">
            ...
            <p class="text-primary text-24 line-height-1 mb-2">430</p>
          </div>
        </b-card>
      </b-col>
      <b-col lg="3" md="6" sm="12">
        ...
        >
          <i class="i-Money-2"></i>
          <div class="content">
            <p class="text-muted mt-2 mb-0">Utilidad</p>
            <p class="text-primary text-24 line-height-1 mb-2">₡780.000</p>
          </div>
        </b-card>
      </b-col>
    </b-row>
    <div class="col-md-12">
        <div class="card mb-30">
          <div class="card-body p-0">
            <h5 class="card-title border-bottom p-3 mb-2">Ordenes Recientes</h5>
      ...
      rows: [
        {
          ...
          pago: '<span class="badge badge-pill badge-outline-danger p-2">Pendiente</span>',
        ...
        },
        {
          ...
          pago: '<span class="badge badge-pill badge-outline-danger p-2">Pago</span>',
